...
export default {
    ...
    async beforeCreate() {
        ...
        this.image = "https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+555555(" + lat + "," + long + ")/" + lat + "," + long + ",16.5,0,0/500x500?access_token=pk.eyJ1IjoiZWxsaW90amFybml0IiwiYSI6ImNsOHRyY3hlYjAyNjczbm53MXJ6Y2dkeTcifQ.DQDPF7QxR1yJifRTX7IGUw"
    },
};
</script>