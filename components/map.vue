...
export default {
    ...
    async beforeCreate() {
        ...
        this.image = "https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+555555(" + lat + "," + long + ")/" + lat + "," + long + ",17,0,0/1278x1278?access_token=pk.eyJ1IjoiZWxsaW90amFybml0IiwiYSI6ImNsOHRyY3hlYjAyNjczbm53MXJ6Y2dkeTcifQ.DQDPF7QxR1yJifRTX7IGUw&logo=false&attribution=false"
    },
};
</script>